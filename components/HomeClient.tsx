...
const HomeClient = ({ email }: { email: string }) => {
  ...
  const feature = [
    {
      title: "Plug & Play",
      desc: "Add the chartbot to your site with a single script tag.",
    },
    {
      title: "Admin Controlled",
      desc: "You control exactly what the AI knows amd answers.",
    },
    {
      title: "Always Online",
      desc: "You customers get instant support 24/7.",
    },
  ];
    ...
    <div className="min-h-screen bg-linear-to-br from-white to-zinc-50 text-zinc-900 overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {email ? (
            <div className="relative" ref={popupRef}>
              <button
                className="w-10 h-10 rounded-full bg-black text-white flex justify-center font-semibold hover:scale-105 transition text-2xl text-center"
            ...
            <button
              onClick={handleLogin}
              className="px-5 py-2 rounded-full bg-black text-white text-sm font-medium hover:bg-zinc-800 transition cursor-pointer"
              disabled={loading}
            >
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg text-zinc-600 max-w-xl">
              ...
              customers get instant answers using your own busniess knowledge.
            </p>
          ...
          >
            <div className="rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-zinc-100 rounded-lg px-4 py-2 text-sm mt-4 w-fit">
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-6 w-14 h-14 rounded-full bg-black textt-white flex items-center justify-center shadow-xl"
            >
              💬
            </motion.div>
          </motion.div>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            Why Busniesses Choose SupportAI
          </motion.h2>
